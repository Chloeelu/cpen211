...
public class DNA {
    ...
    public DNA cutAndSplice(String restrictionEnzyme, int splicePosition, String splicee) {
         ...
         */
        int a = 0;
        for (int i = 0; i < seqNoJunk.length() - restrictionEnzyme.length(); i += restrictionEnzyme.length()) {
        ...
        newSeqBuilder.append(seqNoJunk.substring(a + restrictionEnzyme.length()));
    ...
    public boolean equals(Object o) {
        ...
        DNA dna = (DNA) o;
        return sequence.equals(dna.sequence);
    }
